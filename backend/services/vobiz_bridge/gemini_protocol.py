    ...
    *,
    ...
    if role in ("sales_1",):
        ...
        instruction = (
            ...
            "'I'm reaching out to introduce Solitaire Unity, a premium premium gated apartment community "
            "near Kondapur, Hyderabad, and our latest launch — The Solitaire Unity, a limited "
            "collection of 9 ultra-luxury 5 BHK resort villas. Would you like to know more about it?'\n"
...
async def gemini_send_commission_pitch_nudge(
    ...
    *,
    ...
    instruction = (
        ...
        "'Upon successful sale, each 5 BHK villa gives you 3% commission — around 12 Lakhs — "
